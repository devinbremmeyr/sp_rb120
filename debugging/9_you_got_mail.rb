...
# Error seems to result from sending ellens_postal_service(@street_address)
# as a message (method call) on another PostalService object. (johns_postal_service)
# I suspect this is because the method call to send on line 91 is in fact
# calling Object#send rather than Mailing#send
# This is happening because PostalService does not include the Mailing module
